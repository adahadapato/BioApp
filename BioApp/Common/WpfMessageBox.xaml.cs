...
namespace BioApp
{
    ...
    public partial class WpfMessageBox : Window
    {
        ...
        private static void SetImageOfMessageBox(MessageBoxImage image)
        {
            switch (image)
            {
                case MessageBoxImage.Warning:
                    _messageBox.SetImage("msg_warning.png");
                    break;
                case MessageBoxImage.Question:
                    _messageBox.SetImage("msg_question.png");
                    break;
                case MessageBoxImage.Information:
                    _messageBox.SetImage("msg_information.png");
                    break;
                case MessageBoxImage.Error:
                    _messageBox.SetImage("msg_error.png");
                    break;
        ...
        {
            string uri = string.Format("pack://application:,,,/Images/Dialogue/{0}", imageName);
